...
class baidu_crawler:
    ...
    def get_index(self, key, year, month, leap_year, code):
        ...
        headers = {
            ...
            "Cipher-Text": "1734170655831_1734175112953_",
...
if __name__=="__main__":    
    ...
    cities = []
    cities = ["全国", "黑龙江-哈尔滨", "重庆", "湖南-长沙", "陕西-西安", "山东-淄博"]
    # while True:
    #     # 提示用户输入地域名称
